...
class VideoProgressBar extends StatefulWidget {
  ...
  final void Function(Duration seekDuration)? onDragUpdate;
...
class _ProgressBarPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_ProgressBarPainter painter) {
    return barHeight != painter.barHeight ||
        handleHeight != painter.handleHeight ||
        value != painter.value ||
        colors != painter.colors ||
        draggableValue != painter.draggableValue ||
        drawShadow != painter.drawShadow;
  }
